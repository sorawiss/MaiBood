...
function Inpost() {
    ...
    if (!postData) {
        return (
            <div className="Inpost-wrapper min-h-screen bg-white-bg w-full flex flex-col items-center justify-center p-4">
                <p className="text-gray-500">ไม่พบข้อมูลสำหรับโพสต์นี้</p>
                <Link to="/home" className="mt-4 text-blue-600 hover:underline">กลับหน้าหลัก</Link>
            </div>
        );
    }
            ...
            ">
                ...
                <div className="inpost-detail-container flex flex-col gap-[1rem]  ">
                    <div className="text-details">
                        ...
                        <div className="contact-container flex flex-col gap-[0.5rem] py-[1rem] text-secondary  ">
                            <div className="contact-detail">
                                <svg width="35" height="25" viewBox="0 0 14 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <p className='p2'> <b>{postData.address}</b> ตำบล{postData.subdistrict} อำเภอ{postData.district} จังหวัด{postData.province} รหัสไปรษณีย์ {postData.zip_code} </p>
                            </div>
                    ...
                    <div className="exp-detail px-[1rem] ">
                        <p className='exp-detail-text p2 '>หมดอายุ : {thaiDate(date)}</p>
                    </div>
                </div>
